...
MultiLex-PT contains 5,165 instances from the Bible (2,321), news articles (1,817), and biomedical texts (1,237) and provides continuous complexity values alongside gold candidate simplifications. 
